...
exports.getNotifications = exports.getNotification = exports.getTodayDcard = exports.getStatus = exports.login = exports.getSearchResult = exports.getPostById = exports.getPostsFromForum = exports.getAllForum = exports.fetchWithAuth = undefined;
...
var MEMBER_API = API_ORIGIN + "/member";

var DcardClient = function DcardClient() {
    var _this = this;

    var originalFetch = arguments.length <= 0 || arguments[0] === undefined ? originalFetch : arguments[0];
...
var fetchWithAuth = exports.fetchWithAuth = new DcardClient(_isomorphicFetch2.default).fetch;
...
var getAllForum = exports.getAllForum = function getAllForum() {
    ...
    var fetch = options.auth ? fetchWithAuth : _isomorphicFetch2.default;
...
var getPostsFromForum = exports.getPostsFromForum = function getPostsFromForum() {
    ...
    var fetch = auth ? fetchWithAuth : _isomorphicFetch2.default;
